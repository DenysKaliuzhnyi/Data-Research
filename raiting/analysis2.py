...
data = pd.read_csv('datasets\\rating2.csv')
# print(data)
...
fig.savefig("images2\\total_absolute.png")
...
sns.distplot(data['total'],
             ...
             ax=ax)
ax.set(xticks=np.arange(60, 100+1, 10), xlim=(60, 100))
fig.savefig("images2\\total_relative.png")
...
sns.distplot(data['total'],
             ...
             ax=ax)
ax.set(xticks=np.arange(60, 100+1, 10), xlim=(60, 100))
fig.savefig("images2\\total_density.png")
...
plt.tight_layout()
fig.savefig("images2\group_absolute.png")
...
for (cell, group_name) in zip(ax.flat, group_names):
    ...
    for item in leg.legendHandles:
        item.set_visible(False)
plt.tight_layout()
fig.savefig("images2\group_relative.png")
...
for (cell, group_name) in zip(ax.flat, group_names):
    ...
    for item in leg.legendHandles:
        item.set_visible(False)
plt.tight_layout()
fig.savefig("images2\group_density.png")
...
ax[1, 1].set(xlim=(0, 120))

plt.tight_layout()
fig.savefig("images2\extra_points.png")
